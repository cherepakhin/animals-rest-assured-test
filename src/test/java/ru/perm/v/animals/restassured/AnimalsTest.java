...
//    @Story("Step Animal GET Request ID=1 check STATUS_CODE=200")
...
//    @Story("Step Animal GET Request ID=1 check content")
...
//    @Story("Step Animal GET ID Request with allure ATTACHMENT")
//    @Severity(SeverityLevel.NORMAL)
